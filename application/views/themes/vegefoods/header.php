...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="<?php echo get_theme_uri('css/style2.css'); ?>">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark " id="navbar-expand-lg">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="<?php echo site_url('shop/cart'); ?>" class="nav-link">Keranjang</a></li>
            <li class="nav-item"><a href="<?php echo site_url('customer/payments/confirm'); ?>" class="nav-link">Pembayaran</a></li>
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown05">
				  ...
				  <?php elseif ( is_login() && is_admin()) : ?>
					<a class="dropdown-item" href="<?php echo site_url('admin'); ?>">Beranda</a>
				  <div class="divider"></div>
				  <a class="dropdown-item" href="<?php echo site_url('auth/logout'); ?>">Logout</a>
				  <?php else : ?>
